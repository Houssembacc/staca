...
<div class="header_row_2">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <!-- HEADER CART -->
          	<div class="header_cart"><a href="./cart.php"><i class="fa fa-shopping-cart"></i><b>Cart:</b><span class="cart-total-items"><span class="count">0</span></span><span>item(s)</span><span>&nbsp;&ndash;&nbsp;</span><span class="money cart-total-price">0.00DT</span></a></div>
...
<form method="post" action="ajouterreclamation2.php" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" /><input type="hidden" name="utf8" value="✓" />
...
<div id="contactFormWrapper">
    ...
    <div class="row">
        <div class="col-sm-4 form-group">
            ...
            <input type="text" class="form-control" id="contactFormName" name="objet" placeholder="Title" />
        </div>
        <div class="col-sm-4 form-group">
            <label class="sr-only">Email:</label>
            <input type="email" class="form-control" id="contactFormEmail" name="email" placeholder="Your email..." />
        </div>
       <!-- <div class="col-sm-4 form-group">
    ...
    <div class="row">
        <div class="col-sm-12 form-group">
            ...
            <textarea class="form-control" rows="5" cols="75" id="contactFormMessage" name="message" placeholder="Your Message..."></textarea>
        </div>
    </div>
