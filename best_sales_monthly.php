...
$db=config::getConnexion();
   ...
   $req1= $db->query("SELECT sum(qte) as tot,id_produit as product, DATE_FORMAT(date_vente,'%b') as date_de_vente from ventes_produits GROUP BY DATE_FORMAT(date_vente,'%b')");
   $req1->execute();
